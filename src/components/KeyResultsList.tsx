  ...
  return (
    ...
    <div className="flex flex-col items-center gap-2 w-full justify-start p-6 rounded-lg h-[200px] overflow-y-auto scrollbar-none">
      {keyResultsList.map((keyResult) => {
        let width = keyResult.currentProgress / keyResult.targetProgress * 100;
        return (
          <div
            key={keyResult.id}
            className="w-full flex flex-col items-center gap-6  bg-black/20 shadow-sm border border-slate-200/20 px-5 py-4 hover:shadow-md transition-all"
          >
            ...
            <div className="w-full break-all text-sm md:text-base text-white font-medium">
