...
const KeyResultForm = () => {
  ...
  <button
    ...
    type="button"
    className="mt-2 rounded-xl bg-gradient-to-r from-blue-500 to-indigo-600 text-white px-8 py-3 font-semibold shadow-md hover:shadow-lg hover:scale-[1.03] active:scale-95 transition-all"
  >
    Add Key Result
  </button>
</div>
