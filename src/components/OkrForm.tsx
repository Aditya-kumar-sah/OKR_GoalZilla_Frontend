...
const OkrForm = () => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto rounded-2xl bg-white/70 backdrop-blur-xl shadow-xl border border-slate-200 flex flex-col justify-center py-10 px-8 gap-8">
